 ...
 * ses accents et ses minuscules — c'est elle qui sert à traduire le mot et à
 * en faire une carte du carnet, la table de gloses étant indexée sur la
 * graphie réelle et non sur son cri.
 */
