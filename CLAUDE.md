...
- `creole_translations.json` — French gloss of ~1145 Creole forms, of which 513 are in `creole_dict.json`. Not produced by `KreyolComplet.py`; see `generate_translations.py` below and `Dictionnaires/GLOSES.md`
