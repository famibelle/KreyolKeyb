...
- 🐛 *(v10.1.2)* Jeu de recherche de mots cachés : la notification "mot trouvé" ne recouvre plus la liste des mots (repositionnée en haut de l'écran)
- 🐛 *(v10.1.1)* Correction des onglets tronqués en "…" sur écran étroit (Galaxy A21s)
